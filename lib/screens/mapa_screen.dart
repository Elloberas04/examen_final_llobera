...
class _MapaScreenState extends State<MapaScreen> {
  ...
  Widget build(BuildContext context) {
    final IpInfo ubi = ModalRoute.of(context)!.settings.arguments as IpInfo;
    ...
    final CameraPosition _puntInicial =
        CameraPosition(target: ubi.getLatLng(), zoom: 17, tilt: 50);
    ...
    markers.add(
      Marker(
        infoWindow: InfoWindow(title: ubi.org),
        markerId: const MarkerId('id1'),
        position: ubi.getLatLng(),
      ),
    );
